...
export default function Home() {
  useEffect(() => {
    ...
    const elements = document.querySelectorAll(".scroll-animate-fade-up");
    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12 gradient-yellow gradient-title scroll-animate-fade-up">
            MIND BLOWING FEATURES FOR YOUR PERFEECT CARRER GOAL.
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-2 hover:border-primary transition-colors duration-300 scroll-animate-fade-up"
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonial.map((testimonial, index) => (
              <Card
                key={index}
                className="bg-background scroll-animate-fade-up"
      ...
      <section id="" className="w-full py-12 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div
            className="max-w-3xl mx-auto scroll-animate-fade-up"
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg scroll-animate-fade-up">
